  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.navigationBar}>
        ...
        >
          <Text style={[styles.tab, pageSelected === 1 && { color: "#000" }]}>
            WOMEN
          </Text>
        </TouchableOpacity>
        ...
        >
          <Text style={[styles.tab, pageSelected === 2 && { color: "#000" }]}>
            MEN
          </Text>
        </TouchableOpacity>
        ...
        >
          <Text style={[styles.tab, pageSelected === 3 && { color: "#000" }]}>
            KIDS
          </Text>
        </TouchableOpacity>
        ...
        >
          <Text style={[styles.tab, pageSelected === 4 && { color: "#000" }]}>
            BABY
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.productRow}>
        ...
        <View style={styles.productContainer}>
          ...
          <View style={styles.productDesc}>
            ...
            >
              Online + App-Only Offer Until 10/30
            </Text>
          </View>
        </View>
